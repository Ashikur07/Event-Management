...
export default function LoginPage() {
  ...
  const handleLogin = async (type) => {
    setLoading(true);
    try {
      // গেস্ট মোডের জন্য পাসওয়ার্ড চেক করার দরকার নেই, সরাসরি রোল সেট হবে
      if (type === 'viewer') {
      ...
      <div className="bg-white/80 backdrop-blur-xl w-full max-w-md p-8 rounded-3xl shadow-2xl border border-white/50 text-center relative z-10 animate-in fade-in zoom-in-95 duration-300">
        ...
        <div className="relative mb-6 group">
            ...
            <input 
              ...
              className="w-full pl-11 pr-4 py-4 bg-slate-50 border border-slate-200 rounded-xl text-slate-900 font-bold placeholder-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-transparent outline-none transition-all shadow-sm hover:bg-white"
              value={password}
